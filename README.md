...
<div align="center">
  ...
  <h2 align="center">GoCar Hire- Car Rental Website</h2>

  GoCar Hire is a fully responsive Car Rental Website, <br />Responsive for all devices, build using HTML, CSS, and JavaScript.

  <a href="https://gocarhire.netlify.app/"><strong>➥ Live Demo</strong></a>
...
To run **GoCar Hire** locally, run this command on your git bash:

Linux and macOS:

```bash
sudo git clone https://github.com/Asifmohamed007/GocarHire.git
```

Windows:

```bash
git clone https://github.com/Asifmohamed007/GocarHire.git
```
